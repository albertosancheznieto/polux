package com.albertosancheznieto.polux.test_support;

import com.albertosancheznieto.polux.PoluxApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.albertosancheznieto.polux.screen")
@ContextConfiguration(classes = {PoluxApplication.class, UiTestAssistConfiguration.class})
